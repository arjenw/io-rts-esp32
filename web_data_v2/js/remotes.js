            ...
            [""],
            {
                ...
                onPair: async function (deviceId) {
                    try {
                        ...
                        if (!result.success) { app.logStatus(result.message || "Link failed.", "error"); return; }
                ...
                onUnpair: async function (deviceId) {
                    try {
                        ...
                        if (!result.success) { app.logStatus(result.message || "Unlink failed.", "error"); return; }
                ...
                onDelete: async function () {
                    try {
                        ...
                        if (!result.success) { app.logStatus(result.message || "Delete failed.", "error"); return; }
            ...
            [""],
            {
                ...
                onSave: async function (addr, newName) {
                    ...
                    try {
                        ...
                        if (!result.success) { app.logStatus(result.message || "Add failed.", "error"); return; }
